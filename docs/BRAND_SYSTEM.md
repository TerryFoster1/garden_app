...
- Botanical greens for primary action and structure.
- Soft soil neutrals for grounded surfaces.
- Sunlight yellow for camera/scan and positive emphasis.
- Tomato/coral for weather or plant-stress alerts.
- Rounded cards and friendly typography.
...
- Neutral: soil brown and soft raised-bed beige.
- Accent: sunlight yellow.
- Alert: tomato/coral.
- Support: pale sky for weather.
